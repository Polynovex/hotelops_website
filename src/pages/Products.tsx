  ...
  return (
    <div className="bg-white overflow-hidden">
      ...
      <section className="relative py-20 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto animate-fade-in animation-delay-300">
            Choose individual products or get the complete suite for maximum value. All integrated, all powerful.
          </p>
        </div>
      </section>
      ...
      {products.map((product, index) => {
        ...
        const bgColor = isEven ? 'bg-white' : 'bg-gradient-to-b from-slate-50 to-white';
        const gradients = {
          ...
          <section key={index} className={`py-24 ${bgColor}`}>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div className={`${isEven ? 'order-1' : 'order-1 lg:order-2'} animate-fade-in`}>
                  <div
                  ...
                  <p className={`text-xl font-semibold mb-4 bg-gradient-to-r ${gradients[product.color as keyof typeof gradients]} bg-clip-text text-transparent`}>
                    {product.tagline}
                  </p>
                ...
                <div className={`${isEven ? 'order-2' : 'order-2 lg:order-1'} animate-fade-in animation-delay-200`}>
                  <div className="relative group bg-white rounded-2xl shadow-xl p-8 border border-slate-200 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                    ...
                    <div className={`absolute inset-0 bg-gradient-to-br ${gradients[product.color as keyof typeof gradients]} rounded-2xl opacity-0 group-hover:opacity-10 transition-opacity duration-300`}></div>
                      ...
                      <ul className="space-y-4">
                        {product.features.map((feature, featureIndex) => (
                          <li key={featureIndex} className="flex items-start group/item">
                            ...
                            <span className="text-slate-700 group-hover/item:text-slate-900 transition-colors duration-200">{feature}</span>
                          </li>
                        ))}
                      </ul>
                    </div>
            ...
            {platformFeatures.map((feature, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-lg font-bold text-white mb-2 group-hover:text-blue-100 transition-colors duration-300">{feature.title}</h3>
                  <p className="text-blue-100 group-hover:text-white transition-colors duration-300">{feature.description}</p>
                </div>
              );
            })}
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="group bg-white p-10 rounded-2xl shadow-lg border-2 border-transparent hover:border-blue-500 transition-all duration-300 hover:-translate-y-2 animate-fade-in animation-delay-300">
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-3">Paystack Integration</h3>
            ...
            <div className="group bg-white p-10 rounded-2xl shadow-lg border-2 border-transparent hover:border-emerald-500 transition-all duration-300 hover:-translate-y-2 animate-fade-in animation-delay-400">
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-3">Flutterwave Integration</h3>
              <p className="text-slate-600">
